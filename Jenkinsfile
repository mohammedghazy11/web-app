    ...
    stages {
        ...
        stage('deploy') {
            steps {
                ...
                sh "docker run -itd -p 8085:80 --name web_app elnabawy/my-web-app:${env.BUILD_ID}"
            }
        }
    }
}